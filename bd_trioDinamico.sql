...
INSERT INTO `alumno` (`dni`, `nombre`, `apellido`, `fecha_nacimiento`) VALUES
	...
	(39255959, 'Franco Antonio', 'Robles', '1995-10-12'),
...
-- Volcando datos para la tabla sistema_asistencias.parametros: ~1 rows (aproximadamente)
INSERT INTO `parametros` (`dias_de_clases`, `porcentaje_promocion`, `porcentaje_regular`) VALUES
	(80, 80, 60);
